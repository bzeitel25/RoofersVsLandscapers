...
func _build_visuals() -> void:
	...
	g_mesh.size = Vector3(0.08, 0.1, 0.3)
	gun.mesh = g_mesh
	...
	gun.position = Vector3(0, 0, -0.15)
	visual_root.add_child(gun)
