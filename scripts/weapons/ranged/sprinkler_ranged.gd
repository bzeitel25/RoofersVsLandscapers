...
func _build_visuals() -> void:
	...
	pipe.position = Vector3(0, 0, -0.3)
	visual_root.add_child(pipe)
...
func _fire_projectile() -> void:
	...
	mesh_shape.radius = 0.06
	mesh_shape.height = 0.12
	p_mesh.mesh = mesh_shape
	var p_mat = StandardMaterial3D.new()
	p_mat.albedo_color = Color(0.2, 0.4, 0.9, 0.8)
